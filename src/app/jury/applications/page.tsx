  ...
  const [scholarships, setScholarships] = useState<Scholarship[]>([
    {
        ...
        scientific_areas: [{ name: "Physics", id: "1" }],
        type: "Research",
        deadline: "2023-12-31",
        status: "Under Review",
        publisher: "University A"
    },
    {
        id: "2",
        name: "Chemistry Study Scholarship",
        scientific_areas: [{ name: "Chemistry", id: "2" }],
        type: "Study",
        deadline: "2023-11-30",
        status: "Under Review",
    ...
    {
        id: "3",
        name: "Biology Fieldwork Fund",
        scientific_areas: [{ name: "Biology", id: "3" }],
        type: "Fieldwork",
        deadline: "2023-10-15",
        status: "Under Review",
        publisher: "University C"
    }
    ]);
